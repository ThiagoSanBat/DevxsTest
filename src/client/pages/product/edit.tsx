...
const ProductField = ({ name, defaultValue }) => {
  const [field] = useField(name);
  return <span>{field.value || defaultValue}</span>;
};
...
const ProductManager = () => {
  ...
  const deleteSelected = () => {
    ...
    if (selectedPhotos && selectedPhotos.length > 0) {
      setPhotos(
        photos.filter((ar) => !selectedPhotos.find((rm) => rm.src === ar.src)),
      );
    }
  };
                    ...
                    <div className="px-6">
                      <div className="text-center mt-12">
                        ...
                        <div className="text-sm leading-normal mt-0 mb-2 text-blueGray-400 font-bold uppercase">
                          ...
                          <ProductField name="price" defaultValue="$ 0.00" />
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="flex flex-wrap justify-center">
                        <div className="w-full lg:w-9/12 px-4">
                          <p className="mb-4 text-lg leading-relaxed text-blueGray-700">
                            <ProductField name="description" defaultValue="" />
                          </p>
                        </div>
                      </div>
                    </div>
